...
final reservationListModel =
StateNotifierProvider<ReservationListModel, List<CustomerMyPageReservationRespDto>>((ref) {
  return ReservationListModel([], ref)..initViewModel();
});

class ReservationListModel extends StateNotifier<List<CustomerMyPageReservationRespDto>> {
  Ref _ref;
  ...
  //
  void refresh(List<CustomerMyPageReservationRespDto> mypageReservationDtoList) {
    state = mypageReservationDtoList;
  }
}